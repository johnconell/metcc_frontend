...
export function SearchBar({ id, value, onChange, placeholder = 'Search...', label = 'Search', className = '' }) {
  return (
    <div className={`mgmt-search ${className}`.trim()}>
      <label className="mgmt-search__label" htmlFor={id}>{label}</label>
      <div className="mgmt-search__field">
